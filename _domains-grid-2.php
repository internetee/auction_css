...
<div class="domains-list--wrap">
  <div class="page--header">
    <div class="u-container">
      <form class="ui form form-filter">
        <div class="form-filter--search form-filter--search--left">
          ...
          <div class="form-filter--actions"><i aria-hidden="true" class="th list big link icon"></i><i aria-hidden="true" class="th big link icon active"></i></div>
        </div>
      </form>
    </div>
  </div>
  <div class="u-container">
    <div class="domains-grid-2">
      <div class="domains-grid-2__grid">
        <div class="domains-grid-2__item">
          <a href="#">kinnisvara.ee</a>
        </div>
        <div class="domains-grid-2__item">
          <a href="#">kinnisvara.ee</a>
        </div>
        ...
        <div class="domains-grid-2__item">
          <a href="#">llanfairpwllgwyngyllgogerychwyrndrobwyll-llantysiliogogogoch.com</a>
        </div>
        <div class="domains-grid-2__item">
          <a href="#">kinnisvara.ee</a>
        </div>
