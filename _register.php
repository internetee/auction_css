...
<div class="u-container">
  <div class="register-block ui segment">
    <form class="ui form big">
      ...
      <div class="field">
        ...
        <div class="description">
          <a href="#">Mul puudub isikukood</a>
        </div>
      </div>
      <div class="field">
        <label>Kodakondsus</label>
        <select class="ui search dropdown">
          <option value="">Vali või otsi</option>
      ...
      <div class="form-actions">
        <button class="ui button big primary" type="submit">Registreeri</button>
      </div>
    </form>
  </div>
</div>
