...
<body>
  <div class="app-wrapper test">
    <main class="layout-main" role="main">
      <div class="main-hero smaller orange test"></div>
        ...
        <div class="layout--container">
          <div class="layout--left">  
            <div class="answer-counter">
              ...
              <div class="answer-counter--item current wrong"><a href="_test-wrong.php"><i class="circle orange icon"></i>4. Küsimus</a></div>
          ...
          <div class="layout--right">
            ...
            <div class="layout--right__bottom">
              <h2 class="false">4. Donec id elit non mi porta?</h2>
              <form class="ui form big">
                <div class="inline field">
                  <div class="ui checkbox correct">
                ...
                <div class="inline field">
                  <div class="ui checkbox false">
                    <input type="checkbox" tabindex="2" class="hidden" id="third" checked>
